...
if __name__ == "__main__":
   ...
   # Create threads for each file path
    thread1 = threading.Thread(target=file_parser, args=('C:/Users/ailee/Desktop/in4matx 141/CS121_Assignment3-appendFile/CS121_Assignment3-multipleFiles/ANALYST,'))
   #  thread2 = threading.Thread(target=file_parser2, args=("C:/Users/Lilan/Documents/CS121_Assignment3/DEV2",))
    #thread3 = threading.Thread(target=file_parser3, args=('C:/Users/ailee/Desktop/in4matx 141/CS121_Assignment3-appendFile/CS121_Assignment3-multipleFiles/ANALYST,'))
